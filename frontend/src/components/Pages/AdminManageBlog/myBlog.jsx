...
export default function MyBlogs({ refreshKey, triggerRefresh }) {
    ...
    }, [refreshKey]); // ✅ re-fetch on refreshKey
    ...
    const handleCreate = async () => {
        try {
            ...
            handleClose();
            triggerRefresh(); // ✅ refresh all tabs
        } catch (err) {
            console.error(err);
            ...
            <TableContainer component={Paper}>
                <Table>
                    ...
                    <TableBody>
                        {blogs.length === 0 ? (
                            <TableRow>
                                <TableCell colSpan={6} align="center">No blogs found.</TableCell>
                            </TableRow>
                        ) : (
                            blogs.map(blog => (
                                <TableRow key={blog.id}>
                                    ...
                                    <TableCell>{blog.creator_name || 'You'}</TableCell>
                                    <TableCell>
